...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v10", "EdtCommodityTax"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v10", "EdtTaxDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
