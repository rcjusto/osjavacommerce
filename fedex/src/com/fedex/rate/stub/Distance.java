...
public class Distance  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v10", "Distance"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v10", "DistanceUnits"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
