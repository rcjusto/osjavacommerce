...
public class TrackServiceLocator extends org.apache.axis.client.Service implements com.fedex.track.stub.TrackService {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/track/v5", "TrackService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/track/v5", "TrackServicePort"));
        }
