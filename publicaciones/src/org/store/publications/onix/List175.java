...
public enum List175 {
    ...
    /**
     * Strengthened binding intended for publications.
     * 
     */
    @XmlEnumValue("B306")
    B_306("B306"),
    ...
    /**
     * Strengthened binding, not specifically intended for publications.
     * 
     */
    @XmlEnumValue("B307")
    B_307("B307"),
    ...
    /**
     * The Open EBook format of the IDPF, a predecessor of the full EPUB format, still (2008) supported as part of the latter [File extension .opf].
     * 
     */
    @XmlEnumValue("E102")
    E_102("E102"),
    ...
    /**
     * A format proprietary to Amazon for use with its Kindle reading device [File extension .azw].
     * 
     */
    @XmlEnumValue("E116")
    E_116("E116"),
    ...
    /**
     * A proprietary format for use with Mobipocket software on various hardware platforms [File extension .prc].
     * 
     */
    @XmlEnumValue("E127")
    E_127("E127"),
