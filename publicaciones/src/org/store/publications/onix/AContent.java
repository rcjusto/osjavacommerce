 ...
 *         &lt;element ref="{http://www.editeur.org/onix/3.0/reference}special"/>
 *         &lt;element ref="{http://www.editeur.org/onix/3.0/reference}fontstyle"/>
...
public class AContent {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "fontstyle", namespace = "http://www.editeur.org/onix/3.0/reference", type = JAXBElement.class),
        @XmlElementRef(name = "special", namespace = "http://www.editeur.org/onix/3.0/reference", type = JAXBElement.class),
     ...
     * {@link JAXBElement }{@code <}{@link org.store.publications.onix.Object }{@code >}
