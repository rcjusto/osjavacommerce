...
public class SageProductsJob extends BaseJob {
    public static final String JOB_NAME = "sage.products.synchronization";
        ...
        try {
            ...
            try {
                ...
                if (job != null && job.getActive()) {
                    try {
                        SageCatalogTask sageUtils = new SageCatalogTask(storeCode, job, databaseConfig);
                        sageUtils.start();
                        buff.append("Products Synchronization: OK");
